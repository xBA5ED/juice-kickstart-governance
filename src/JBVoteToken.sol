...
/** 
  @notice
  An ERC-20 token that can be used by a project in the `JBTokenStore` and uses checkpointing for on-chain voting.
  ...
  @dev
  Inherits from -
  ERC20Votes: General token standard for fungible accounting with additions to support governance
  Ownable: Includes convenience functionality for checking a message sender's permissions before executing certain transactions.
*/
contract JBVoteToken is ERC20Votes, Ownable, ERC165, IJBToken {
    //*********************************************************************//
    // ------------------------- external views -------------------------- //
    //*********************************************************************//
  ...
  */
    ...
    {
        return
            interfaceId == type(IJBToken).interfaceId ||
